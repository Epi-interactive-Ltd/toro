# Add a symbol layer to a map or map proxy. This layer is typically used for icons or pins.

Add a symbol layer to a map or map proxy. This layer is typically used
for icons or pins.

## Usage

``` r
add_symbol_layer(map, ...)
```
