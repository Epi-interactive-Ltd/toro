...
- Perform a [search](https://epi-interactive-ltd.github.io/issues) to
  see if the enhancement has already been suggested (there is an
  *enhancement* label). If it has, add a comment to the existing issue
...
This file is already included in the `.gitignore` and will allow you to
test your changes in a Shiny app.

To test outside of a Shiny app simply run:

- [`devtools::load_all()`](https://devtools.r-lib.org/reference/load_all.html)
  to load the most recent changes from the local repository.
...
you through the process of making a PR and ensuring that you have done
