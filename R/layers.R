...
#'
#' @note If `source` is not a string referring to an existing source, it will be converted to a
...
#' @export
#'
#' @seealso [get_paint_options()] for paint customisation, [get_layout_options()] for layout
...
#' @return The map or map proxy object for chaining.
#' @seealso [get_tile_options()] for retrieving all tile options.
#' @export
#'
#' @examples
#' if(interactive()){
